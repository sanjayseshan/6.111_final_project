...
#
# Script generated by Vivado on Sat Oct 28 15:09:24 EDT 2023
# SW Build 3865809 on Sun May  7 15:04:56 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : inv_sqrt.sh
...
#
# Usage        : inv_sqrt.sh
#                inv_sqrt.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                inv_sqrt.sh [-reset_run]
#                inv_sqrt.sh [-reset_log]
#                inv_sqrt.sh [-help]
#
...
#                script (type 'inv_sqrt.sh -help' for more information).
#
...
# script info
echo -e "inv_sqrt.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./inv_sqrt.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.inv_sqrt xil_defaultlib.glbl -o inv_sqrt_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./inv_sqrt_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key inv_sqrt_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc inv_sqrt_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./inv_sqrt.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: inv_sqrt.sh [-help]\n\
Usage: inv_sqrt.sh [-step]\n\
Usage: inv_sqrt.sh [-lib_map_path]\n\
Usage: inv_sqrt.sh [-reset_run]\n\
Usage: inv_sqrt.sh [-reset_log]\n\
Usage: inv_sqrt.sh [-keep_index]\n\
Usage: inv_sqrt.sh [-noclean_files]\n\n\
