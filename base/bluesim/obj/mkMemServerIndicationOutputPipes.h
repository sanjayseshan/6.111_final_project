...
class MOD_mkMemServerIndicationOutputPipes : public Module {
 ...
 public:
  tUInt8 DEF_error_responseAdapter_notEmptyReg__h888;
  tUInt8 DEF_reportMemoryTraffic_responseAdapter_notEmptyReg__h842;
  tUInt8 DEF_reportStateDbg_responseAdapter_notEmptyReg__h772;
 ...
 private:
  tUWide DEF_x__h1546;
  tUWide DEF_x__h1294;
  tUInt64 DEF_x__h1420;
  tUInt64 DEF_x__h1167;
  tUWide DEF_error_responseAdapter_bits_BITS_159_TO_0___h1651;
  tUWide DEF_reportStateDbg_responseAdapter_bits_BITS_95_TO_0___h1399;
  tUWide DEF_x__h1644;
  tUWide DEF_x__h1392;
