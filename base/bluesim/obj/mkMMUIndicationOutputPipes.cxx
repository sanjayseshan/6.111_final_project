...
MOD_mkMMUIndicationOutputPipes::MOD_mkMMUIndicationOutputPipes(tSimStateHdl simHdl,
  ...
  : Module(simHdl, name, parent),
    ...
    DEF_x__h967(192u),
    DEF_error_responseAdapter_bits_BITS_159_TO_0___h1073(160u),
    DEF_x__h1065(192u)
{
...
void MOD_mkMMUIndicationOutputPipes::init_symbols_0()
{
  ...
  init_symbol(&symbols[2u],
	      "configResp_responseAdapter_notEmptyReg__h553",
	      SYM_DEF,
	      &DEF_configResp_responseAdapter_notEmptyReg__h553,
	      1u);
  ...
  init_symbol(&symbols[7u],
	      "error_responseAdapter_notEmptyReg__h599",
	      SYM_DEF,
	      &DEF_error_responseAdapter_notEmptyReg__h599,
	      1u);
...
tUInt8 MOD_mkMMUIndicationOutputPipes::METH_RDY_methods_configResp_enq()
{
  ...
  DEF_configResp_responseAdapter_notEmptyReg__h553 = INST_configResp_responseAdapter_notEmptyReg.METH_read();
  DEF_NOT_configResp_responseAdapter_notEmptyReg___d4 = !DEF_configResp_responseAdapter_notEmptyReg__h553;
...
tUInt8 MOD_mkMMUIndicationOutputPipes::METH_RDY_methods_error_enq()
{
  ...
  DEF_error_responseAdapter_notEmptyReg__h599 = INST_error_responseAdapter_notEmptyReg.METH_read();
  DEF_NOT_error_responseAdapter_notEmptyReg___d6 = !DEF_error_responseAdapter_notEmptyReg__h599;
...
tUInt8 MOD_mkMMUIndicationOutputPipes::METH_RDY_portalIfc_indications_1_first()
{
  ...
  DEF_configResp_responseAdapter_notEmptyReg__h553 = INST_configResp_responseAdapter_notEmptyReg.METH_read();
  DEF_CAN_FIRE_portalIfc_indications_1_first = DEF_configResp_responseAdapter_notEmptyReg__h553;
...
tUInt8 MOD_mkMMUIndicationOutputPipes::METH_RDY_portalIfc_indications_1_deq()
{
  ...
  DEF_configResp_responseAdapter_notEmptyReg__h553 = INST_configResp_responseAdapter_notEmptyReg.METH_read();
  DEF_CAN_FIRE_portalIfc_indications_1_deq = DEF_configResp_responseAdapter_notEmptyReg__h553;
...
tUInt8 MOD_mkMMUIndicationOutputPipes::METH_portalIfc_indications_1_notEmpty()
{
  ...
  DEF_configResp_responseAdapter_notEmptyReg__h553 = INST_configResp_responseAdapter_notEmptyReg.METH_read();
  PORT_portalIfc_indications_1_notEmpty = DEF_configResp_responseAdapter_notEmptyReg__h553;
...
tUInt32 MOD_mkMMUIndicationOutputPipes::METH_portalIfc_indications_2_first()
{
  ...
  DEF_x__h967 = INST_error_responseAdapter_bits.METH_read();
  PORT_portalIfc_indications_2_first = DEF_x__h967.get_whole_word(5u);
...
tUInt8 MOD_mkMMUIndicationOutputPipes::METH_RDY_portalIfc_indications_2_first()
{
  ...
  DEF_error_responseAdapter_notEmptyReg__h599 = INST_error_responseAdapter_notEmptyReg.METH_read();
  DEF_CAN_FIRE_portalIfc_indications_2_first = DEF_error_responseAdapter_notEmptyReg__h599;
...
void MOD_mkMMUIndicationOutputPipes::METH_portalIfc_indications_2_deq()
{
  ...
  wop_primExtractWide(160u,
		      ...
		      32u,
		      0u,
		      DEF_error_responseAdapter_bits_BITS_159_TO_0___h1073);
  DEF_error_responseAdapter_count_1_EQ_5___d12 = DEF__read__h391 == (tUInt8)5u;
  DEF_x__h1024 = (tUInt8)7u & (DEF__read__h391 + (tUInt8)1u);
  DEF_IF_error_responseAdapter_count_1_EQ_5_2_THEN_0_ETC___d14 = DEF_error_responseAdapter_count_1_EQ_5___d12 ? (tUInt8)0u : DEF_x__h1024;
  DEF_x__h1065.set_whole_word(DEF_error_responseAdapter_bits_BITS_159_TO_0___h1073.get_whole_word(4u),
			      5u).set_whole_word(DEF_error_responseAdapter_bits_BITS_159_TO_0___h1073.get_whole_word(3u),
						 4u).set_whole_word(DEF_error_responseAdapter_bits_BITS_159_TO_0___h1073.get_whole_word(2u),
								    3u).set_whole_word(DEF_error_responseAdapter_bits_BITS_159_TO_0___h1073.get_whole_word(1u),
										       2u).build_concat((((tUInt64)(DEF_error_responseAdapter_bits_BITS_159_TO_0___h1073.get_whole_word(0u))) << 32u) | (tUInt64)(0u),
													0u,
													64u);
  DEF_NOT_error_responseAdapter_count_1_EQ_5_2___d15 = !DEF_error_responseAdapter_count_1_EQ_5___d12;
  DEF_x__h1052 = 511u & (DEF__read__h427 + 32u);
  ...
  if (DEF_NOT_error_responseAdapter_count_1_EQ_5_2___d15)
    INST_error_responseAdapter_shift.METH_write(DEF_x__h1052);
  if (DEF_NOT_error_responseAdapter_count_1_EQ_5_2___d15)
    INST_error_responseAdapter_bits.METH_write(DEF_x__h1065);
}
...
tUInt8 MOD_mkMMUIndicationOutputPipes::METH_RDY_portalIfc_indications_2_deq()
{
  ...
  DEF_error_responseAdapter_notEmptyReg__h599 = INST_error_responseAdapter_notEmptyReg.METH_read();
  DEF_CAN_FIRE_portalIfc_indications_2_deq = DEF_error_responseAdapter_notEmptyReg__h599;
...
tUInt8 MOD_mkMMUIndicationOutputPipes::METH_portalIfc_indications_2_notEmpty()
{
  ...
  DEF_error_responseAdapter_notEmptyReg__h599 = INST_error_responseAdapter_notEmptyReg.METH_read();
  PORT_portalIfc_indications_2_notEmpty = DEF_error_responseAdapter_notEmptyReg__h599;
...
tUInt8 MOD_mkMMUIndicationOutputPipes::METH_portalIfc_intr_status()
{
  ...
  DEF_configResp_responseAdapter_notEmptyReg__h553 = INST_configResp_responseAdapter_notEmptyReg.METH_read();
  DEF_idResponse_responseAdapter_notEmptyReg__h504 = INST_idResponse_responseAdapter_notEmptyReg.METH_read();
  DEF_configResp_responseAdapter_notEmptyReg_OR_erro_ETC___d20 = DEF_configResp_responseAdapter_notEmptyReg__h553 || DEF_error_responseAdapter_notEmptyReg__h599;
...
tUInt32 MOD_mkMMUIndicationOutputPipes::METH_portalIfc_intr_channel()
{
  ...
  DEF_configResp_responseAdapter_notEmptyReg__h553 = INST_configResp_responseAdapter_notEmptyReg.METH_read();
  DEF_idResponse_responseAdapter_notEmptyReg__h504 = INST_idResponse_responseAdapter_notEmptyReg.METH_read();
  DEF_IF_configResp_responseAdapter_notEmptyReg_THEN_ETC___d22 = DEF_configResp_responseAdapter_notEmptyReg__h553 ? 1u : (DEF_error_responseAdapter_notEmptyReg__h599 ? 2u : 4294967295u);
...
unsigned int MOD_mkMMUIndicationOutputPipes::dump_VCD_defs(unsigned int levels)
{
  ...
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  vcd_write_def(sim_hdl, num++, "configResp_responseAdapter_notEmptyReg__h553", 1u);
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  vcd_write_def(sim_hdl, num++, "error_responseAdapter_bits_BITS_159_TO_0___h1073", 160u);
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  vcd_write_def(sim_hdl, num++, "error_responseAdapter_notEmptyReg__h599", 1u);
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  vcd_write_def(sim_hdl, num++, "idResponse_responseAdapter_notEmptyReg__h504", 1u);
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  vcd_write_def(sim_hdl, num++, "x__h1065", 192u);
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  vcd_write_def(sim_hdl, num++, "x__h967", 192u);
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
					      ...
					      MOD_mkMMUIndicationOutputPipes &backing)
{
  ...
  if (dt == VCD_DUMP_XS)
  {
	...
	backing.PORT_RST_N = PORT_RST_N;
      ...
      ++num;
      if ((backing.DEF_configResp_responseAdapter_notEmptyReg__h553) != DEF_configResp_responseAdapter_notEmptyReg__h553)
      {
	vcd_write_val(sim_hdl, num, DEF_configResp_responseAdapter_notEmptyReg__h553, 1u);
	backing.DEF_configResp_responseAdapter_notEmptyReg__h553 = DEF_configResp_responseAdapter_notEmptyReg__h553;
      }
      ++num;
      if ((backing.DEF_error_responseAdapter_bits_BITS_159_TO_0___h1073) != DEF_error_responseAdapter_bits_BITS_159_TO_0___h1073)
      {
	vcd_write_val(sim_hdl, num, DEF_error_responseAdapter_bits_BITS_159_TO_0___h1073, 160u);
	backing.DEF_error_responseAdapter_bits_BITS_159_TO_0___h1073 = DEF_error_responseAdapter_bits_BITS_159_TO_0___h1073;
      }
      ++num;
      if ((backing.DEF_error_responseAdapter_notEmptyReg__h599) != DEF_error_responseAdapter_notEmptyReg__h599)
      {
	vcd_write_val(sim_hdl, num, DEF_error_responseAdapter_notEmptyReg__h599, 1u);
	backing.DEF_error_responseAdapter_notEmptyReg__h599 = DEF_error_responseAdapter_notEmptyReg__h599;
      }
      ++num;
	...
	backing.DEF_idResponse_responseAdapter_notEmptyReg__h504 = DEF_idResponse_responseAdapter_notEmptyReg__h504;
      ...
      ++num;
      if ((backing.DEF_x__h1065) != DEF_x__h1065)
      {
	vcd_write_val(sim_hdl, num, DEF_x__h1065, 192u);
	backing.DEF_x__h1065 = DEF_x__h1065;
      }
      ++num;
      if ((backing.DEF_x__h967) != DEF_x__h967)
      {
	vcd_write_val(sim_hdl, num, DEF_x__h967, 192u);
	backing.DEF_x__h967 = DEF_x__h967;
      }
      ++num;
