...
class MOD_mkMMUSynth : public Module {
 ...
 public:
  ...
  tUInt8 DEF_regall_cbram_counter_1_positive_reg__h12551;
  tUInt8 DEF_translationTable_cbram_counter_0_positive_reg__h11890;
  ...
  tUInt32 DEF_sglId_gen_comp_state__h988;
