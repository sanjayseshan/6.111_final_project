...
#
# Script generated by Vivado on Wed Nov 01 21:31:22 EDT 2023
...
#
# Usage        : addsub.sh
#                addsub.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                addsub.sh [-reset_run]
#                addsub.sh [-reset_log]
#                addsub.sh [-help]
#
...
#                script (type 'addsub.sh -help' for more information).
#
...
# script info
echo -e "addsub.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./addsub.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.addsub xil_defaultlib.glbl -o addsub_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./addsub_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/sanjay/Documents/6.111/lab08/project_2/project_2.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key addsub_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc addsub_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./addsub.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: addsub.sh [-help]\n\
Usage: addsub.sh [-step]\n\
Usage: addsub.sh [-lib_map_path]\n\
Usage: addsub.sh [-reset_run]\n\
Usage: addsub.sh [-reset_log]\n\
Usage: addsub.sh [-keep_index]\n\
Usage: addsub.sh [-noclean_files]\n\n\
